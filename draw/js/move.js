...
function pageLoad(){
	...
	{imgWidth=(_imgW/3-40)*_a;imgHeight=_pageHx*_b/3-10;	}
	else
	{imgWidth=(_imgW*9/20-40)*_a;imgHeight=_pageHx*2*_b/5-10;}		
...
function ty(i){	
	...
	if(i==0) {top=DataUrlNum;_canvasHeights=_canvasHeight-top;}			
	output.onload = function(){			
		ctx.drawImage(output,0,top,_canvasWidth,_canvasHeights);
		if(dore==1)
		backDrawCircle();//无延时绘制图	
	}	
}
