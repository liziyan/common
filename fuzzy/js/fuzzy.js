...
*
*/
//t为模拟的从数据库读出来的json字符串，实际项目中删除掉
var t={"errCode":"000000","errMsg":"业务交易成功","pageDto":{"page":"1","records":"53","rows":[{"id":"0","master":"1511168247","numIid":"11","shopNick":"hello","status":"1"},{"id":"2","master":"1511168247","numIid":"11","shopNick":"hello","status":"1"},{"id":"3","master":"1511168247","numIid":"11","shopNick":"hello","status":"1"},{"downNotice":"20150706:铺货失败,已存在相同商家编码的商品!","id":"98","master":"1511168247","numIid":"45098582937","outerId":"21963","platType":"TB","price":1,"shopId":"16203841083015173","shopNick":"hello","shopTitle":"abc","status":"1","title":"支持购买"},{"downNotice":"20150806:铺货失败,已存在相同商家编码的商品!","id":"134","master":"1511168247","numIid":"3838293428","outerId":"12345","platType":"YG","price":200.7,"shopId":"31841748607041536","shopNick":"hello","shopTitle":"111","status":"1","title":"Nokia N97全新行"},{"downNotice":"20150806:铺货失败,已存在相同商家编码的商品!","id":"135","master":"1511168247","numIid":"3838293429","outerId":"123456","platType":"YG","price":200.8,"shopId":"31841748607041536","shopNick":"hello","shopTitle":"222","status":"1","title":"Nokia N97全新行2"},{"downNotice":"20150825:铺货失败,已存在相同商家编码的商品!","id":"860","master":"1511168247","numIid":"426","outerId":"0","platType":"YG","price":5,"shopId":"31841748607041536","shopNick":"hello","shopTitle":"333","status":"1","title":"农家纯手工粽子"},{"downNotice":"20150828:铺货成功!","id":"869","master":"1511168247","numIid":"427","outerId":"0","platType":"YG","price":5,"shopId":"31841748607041536","shopTitle":"444","status":"1","title":"农家纯手工粽子"},{"downNotice":"20150828:铺货成功!","id":"870","master":"1511168247","numIid":"428","outerId":"0","platType":"YG","price":5,"shopId":"31841748607041536","shopTitle":"afsfsdf","status":"1","title":"饺子"},{"downNotice":"20150828:铺货成功!","id":"871","master":"1511168247","numIid":"429","outerId":"0","platType":"YG","price":5,"shopId":"31841748607041536","shopTitle":"sasfasetafa","status":"1","title":"饺子"}],"total":"6"},"success":true};
(function ($) {
	...
	require.prototype={
		...
		_ajax:function(obj){		
			...
			//本地测试数据
			if(opt.isLocal){
				var v=$.trim(obj.val()),re=t.pageDto.rows,st=[];
				for(var i=0;i<re.length;i++){
					var name = re[i][opt.keyword];
					if(name){
						if(name.indexOf(v)!=-1)
						{
							st.push(re[i]);
				...
				//ajax请求,实际项目用到时在解释并将上面的本地测试数据注释
				ajaxCall({
					url:opt.url,
					params:opt.params,
